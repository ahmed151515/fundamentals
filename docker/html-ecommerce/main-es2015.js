...
let AdminLoginComponent = class AdminLoginComponent {
    constructor(router, logsign_service) {
        this.router = router;
...
let UserCrudComponent = class UserCrudComponent {
    constructor(formBuilder, router, admin_service) {
...
UserCrudComponent.ctorParameters = () => [
...
let ApiService = class ApiService {
    ...
    get(path, params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()) {
        return this.http.get(path, { params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.formatErrors));
    }
    put(path, body = {}) {
        return this.http
...
let BuyerDashboardComponent = class BuyerDashboardComponent {
...
BuyerDashboardComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
SellerDashboardComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services_customer_service__WEBPACK_IMPORTED_MODULE_3__["CustomerService"] }
];
...
let SigninSignupComponent = class SigninSignupComponent {
    constructor(formBuilder, router, logsign_service) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.logsign_service = logsign_service;
        this.regForm = false;
...
SigninSignupComponent.ctorParameters = () => [
...
let ProductCrudComponent = class ProductCrudComponent {
    constructor(formBuilder, router, product_service) {
        this.formBuilder = formBuilder;
        this.router = router;
...
ProductCrudComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
let PageNotFoundErrorComponent = class PageNotFoundErrorComponent {
...
PageNotFoundErrorComponent.ctorParameters = () => [
...
let AdminAuthGuardLogin = class AdminAuthGuardLogin {
    constructor(router) {
        this.router = router;
    }
...
AdminAuthGuardLogin.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let AdminAuthGaurdService = class AdminAuthGaurdService {
    constructor(router) {
        this.router = router;
    }
    canActivate(route, state) {
...
AdminAuthGaurdService.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let SellerBuyerAuthGuardLogin = class SellerBuyerAuthGuardLogin {
    constructor(router) {
        this.router = router;
    }
    canActivate(route, state) {
...
SellerBuyerAuthGuardLogin.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let SellerAuthGaurdService = class SellerAuthGaurdService {
    constructor(router) {
        this.router = router;
    }
    canActivate(route, state) {
...
SellerAuthGaurdService.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let BuyerAuthGaurdService = class BuyerAuthGaurdService {
    constructor(router) {
        this.router = router;
    }
    canActivate(route, state) {
...
BuyerAuthGaurdService.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let LoginSignupService = class LoginSignupService {
...
LoginSignupService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _core_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
...
let UserService = class UserService {
    ...
    //update data of individual user
    updateUserData(user_id, user_dto) {
        return this.apiService.put(this.user_url + user_id, user_dto);
    }
};
...
let UserProfileComponent = class UserProfileComponent {
    constructor(formBuilder, router, user_service, toastr) {
        this.formBuilder = formBuilder;
        this.router = router;
